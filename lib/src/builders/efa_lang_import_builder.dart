...
import 'package:app_strings/src/generators/efa_lang_source_generator.dart';
...
class EFALangImportBuilder extends GeneratorForAnnotation<EFALang> {
  @override
  Future<String?> generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    var exclude = annotation.peek("removeLocale")?.stringValue;
